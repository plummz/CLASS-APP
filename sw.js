...
const ASSETS = [
  ...
  '/coding-educational/coding-educational.css?v=2',
  ...
  '/coding-educational/coding-educational-data.js?v=2',
  '/coding-educational/coding-educational.js?v=2',
  ...
  if (event.request.mode === 'navigate' || requestUrl.pathname.endsWith('/index.html')) {
    event.respondWith(
      fetch(event.request)
        ...
        .catch(() => caches.match('/') || caches.match('/index.html?v=71'))
    );
    return;
  }
